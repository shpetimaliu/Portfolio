    ...
    >
      ...
      <div className="mt-10 max-w-2xl space-y-6 text-base">
        <p>
          ...
          the economic school in my city. After completing high school, thoughts
          turned towards starting university in the field of computer science.
          However, at that time, an opportunity arose for a professional job in
          web programming. I chose to follow the path of a professional career,
          considering it the best part of my life. Experience in this field has
          allowed me to develop professionally and achieve significant success
          in my career.
        </p>
      </div>
    </Intro>
