...
function Experience({ props }) {
  ...
  const [hovered1, useHovered1] = useState(false);
  return (
    <Container>
        ...
        <div className="flex md:pl-10 space-x-3 md:space-x-10">
          <div className="flex flex-col items-center">
            ...
            >
              ...
              <span className="absolute left-0 top-0 h-full w-full glow-exp z-[3]"></span>
            </motion.div>
            <motion.div
              initial={{ height: 0 }}
              whileInView={{ height: "100%" }}
              transition={{ duration: 0.4, delay: 0.6 }}
              className="h-full w-[3px] max-md:w-[2px] mt-7 rounded-md bg-gray bg-[#733787] from-[#733787]"
            ></motion.div>
          </div>
          <div className="md:w-10/12 mb-24">
            <motion.div
              ...
              viewport={{ once: false }}
              className="text-[22px] md:text-2xl mb-7 font-bold text-black"
            >
              Experience
            </motion.div>
            <motion.div
            ...
            >
              <span className="text-[#7ee787]">Lorem ipsum text here is</span>
